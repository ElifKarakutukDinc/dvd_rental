--film count and rental count by categories
...
movie_rent_total as (select category_id,  count(rental_id) as rental_count
from film_category_1 as table_1
inner join film_rent_table as table_2 on (table_1.film_id = table_2.film_id)
group by 1)

select category."name", fct.*,  movie_rent_total.rental_count 
